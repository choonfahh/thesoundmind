...
const desktopBrowser = {
  chrome: () => <div>
                  <Header size="large">You haven't activate any Ad Blocker in your Chrome desktop browser :(</Header>
                  <Header.Subheader size="small">Activate it and refresh the page! <br />
                  <i>Note: uBlock Origin isn't supported.</i></Header.Subheader>
                </div>,
  firefox: () => <div>
                   <Header size="large">You haven't activate any Ad Blocker in your Firefox desktop browser :(</Header>
                     <Header.Subheader size="small">Activate it and refresh the page! <br />
                     <i>Note: uBlock Origin isn't supported.</i></Header.Subheader>
                 </div>,
  opera: () => <div>
                 <Header size="large">You haven't activate any Ad Blocker in your Opera desktop browser :(</Header>
                   <Header.Subheader size="small">Activate it and refresh the page! <br />
                   <i>Note: uBlock Origin isn't supported.</i></Header.Subheader>
               </div>,
  safari: () => <div>
                  <Header size="large">You haven't activate any Ad Blocker in your Safari desktop browser :(</Header>
                    <Header.Subheader size="small">Activate it and refresh the page! <br />
                    <i>Note: uBlock Origin isn't supported.</i></Header.Subheader>
                </div>,
  edge: () => <div>
              <Header size="large">You haven't activate any Ad Blocker in your Edge desktop browser :(</Header>
                <Header.Subheader size="small">Activate it and refresh the page! <br />
                <i>Note: uBlock Origin isn't supported.</i></Header.Subheader>
            </div>,
  default: (browser) => <div>
...
const mobileBrowser = {
  firefox: () => <div>
                   <Header size="large">You haven't activate any Ad Blocker in your Firefox mobile browser :(</Header>
                     <Header.Subheader size="small">Activate it and refresh the page! <br />
                     <i>Note: uBlock Origin isn't supported.</i></Header.Subheader>
                 </div>,
  opera: () => <div>
                 <Header size="large">You haven't activate any Ad Blocker in your Opera mobile browser :(</Header>
                   <Header.Subheader size="small">Activate it and refresh the page! <br />
                   <i>Note: uBlock Origin isn't supported.</i></Header.Subheader>
               </div>,
  default: (browser) => <div>
